...
```
 15 5 N))  2 N  1   
```
Você tem 15 pontos, restam 5 tiros, a arma selecionada pode destruir ataques inimigos do tipo N, existem 2 escudos, existem 3 ataques inimigos ativos (de tipo 2, N e 1).
