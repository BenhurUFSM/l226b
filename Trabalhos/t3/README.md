...
A função `calc` deve usar a função `tokeniza` para separar a string em uma lista de substrings chamadas *tokens*.
A função `calc` deve ter mais duas listas, que implementam pilhas, uma para operandos e outra para operadores.
